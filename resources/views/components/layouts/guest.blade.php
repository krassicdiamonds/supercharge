    ...
    <header class="top-0 sticky px-5 sm:px-10 md:px-20 lg:px-40 py-5">
        <div class="flex justify-between items-center">
            <a href="{{ route('welcome') }}" class="flex items-center gap-x-1">
                {{-- icon --}}
                <div class="p-0.5 sm:p-1 border border-yellow-100 rounded-full">
            ...
            <div class="flex items-center gap-x-2.5 sm:gap-x-5">

                <a class="hover:shadow px-2.5 sm:px-5 py-0.5 sm:py-1 border border-gray-500 rounded-sm text-xs sm:text-sm capitalize transition-shadow duration-150" href="{{ route('show.login') }}">login</a>

                <a class="bg-black hover:shadow px-2.5 sm:px-5 py-0.5 sm:py-1 rounded-sm text-white text-xs sm:text-sm capitalize transition-shadow duration-150" href="{{ route('show.register') }}">register</a>

            </div>
        </div>
    </header>
    {{-- main --}}
    <main class="px-5 sm:px-20 md:px-40">
        {{ $slot }}
    </main>
    {{-- footer --}}
